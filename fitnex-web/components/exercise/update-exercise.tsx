...
import type { SingleExerciseType } from "./single-exercise-view";

export function UpdateExerciseComponent({ exercise }: { exercise: SingleExerciseType | undefined }) {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-8 text-center">Updating An Exercise</h1>
      <Link
        href="/exercise"
