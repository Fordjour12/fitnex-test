...
export function SideQuestOverviewComponent() {
  return (
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          <Card>
            ...
            <div className="inline-flex gap-4 pb-3 pl-6">
              <DeleteModalComponent
                questName="30-Day Ab Challenge"
                onDelete={() => {
                  console.log("Delete side quest");
                }}
              />
              <Button asChild>
                <Link href="/sidequest/edit-side-quest">
                  Edit Side Quest
                </Link>
              </Button>
            </div>
