				...
				<Card>
					<CardHeader>
						<CardTitle className="text-2xl font-bold">
							{watchedValues.name || "Your Workout Name"}
						</CardTitle>
					</CardHeader>
					<CardContent className="space-y-4">
						{watchedValues.cover_image?.length ? (
							<div className="w-full h-48 rounded-lg overflow-hidden">
								<img
									src={URL.createObjectURL(watchedValues.cover_image[0])}
						...
						<div className="flex flex-grow gap-6">
							<Badge>{watchedValues.difficulty_level || "level"}</Badge>
						...
						<ScrollArea>
							<Table>
								...
								<TableBody>
									{fields.map((field, index) => (
										<TableRow key={field.id}>
											{watchedValues.workout_exercises[index].type ===
											"exercise" ? (
												<Fragment>
													<TableCell>
														{watchedValues.workout_exercises[index].type ||
													...
													<TableCell>
														{watchedValues.workout_exercises[index]
															.exercise_id || 0}
													</TableCell>
													<TableCell>
														{watchedValues.workout_exercises[index].reps || 0}
													</TableCell>
													<TableCell>
														{watchedValues.workout_exercises[index].duration ||
															0}
													</TableCell>
													<TableCell>
														{watchedValues.workout_exercises[index].set || 0}
													</TableCell>
													<TableCell>
														{watchedValues.workout_exercises[index]
															.order_index || 0}
												...
												<Fragment>
													...
													<TableCell>
														{(watchedValues.workout_exercises[index].type &&
															watchedValues.workout_exercises[index].set) ||
															0}
													</TableCell>
													<TableCell>
														{watchedValues.workout_exercises[index]
